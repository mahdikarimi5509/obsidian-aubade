...
5.  Paste the `theme.css` file into this folder.
6.  In Obsidian, go to **Settings > Appearance > Themes** and select **Aubade**.

## Typography

For the intended experience, ensure the following fonts are installed on your system:
